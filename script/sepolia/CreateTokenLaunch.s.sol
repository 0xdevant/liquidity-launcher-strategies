...
import {SepoliaConstants} from "../common/SepoliaConstants.sol";
import {MineHookSalts} from "../common/MineHookSalts.sol";
import {Log} from "../common/Log.sol";

contract CreateTokenLaunchSepoliaScript is Script, SepoliaConstants, MineHookSalts, Log {
    function run() public {
        vm.startBroadcast();
        ...
        recordDeployment(precomputedAddress, deployedLbp, "Sepolia");
