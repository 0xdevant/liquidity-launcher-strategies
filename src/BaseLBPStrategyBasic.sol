...
import {HookBasic} from "liquidity-launcher/src/utils/HookBasic.sol";
...
/// @title BaseLBPStrategyBasic
/// @notice Base LBP Strategy forked from LBPStrategyBasic to make it inheritable by custom strategies.
abstract contract BaseLBPStrategyBasic is ILBPStrategyBasic, HookBasic {
    ...
    function _transferAssetsAndExecutePlan(MigrationData memory data, bytes memory plan) internal {
