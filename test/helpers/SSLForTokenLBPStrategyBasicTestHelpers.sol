...
abstract contract SSLForTokenLBPStrategyBasicTestHelpers is Test {
    ...
    function assertLBPStateAfterMigration(SSLForTokenLBPStrategyBasic lbp, address token, address currency)
        internal
        view
    {
    ...
    function sendTokensToLBP(address liquidityLauncher, IERC20 token, SSLForTokenLBPStrategyBasic lbp, uint256 amount)
        internal
    {
    ...
    function mockAuctionClearingPrice(SSLForTokenLBPStrategyBasic lbp, uint256 price) internal {
    ...
    function mockCurrencyRaised(SSLForTokenLBPStrategyBasic lbp, uint256 amount) internal {
    ...
    function mockAuctionEndBlock(SSLForTokenLBPStrategyBasic lbp, uint64 blockNumber) internal {
    ...
    function mockAuctionCheckpoint(SSLForTokenLBPStrategyBasic lbp, Checkpoint memory checkpoint) internal {
