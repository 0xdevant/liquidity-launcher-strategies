...
import {SSLForTokenLBPStrategyBasicHarness} from "./SSLForTokenLBPStrategyBasicHarness.sol";

/// @title MockSSLForTokenLBPStrategyBasicFactory
/// @notice Mock factory for the SSLForTokenLBPStrategyBasic contract
contract MockSSLForTokenLBPStrategyBasicFactory is IDistributionStrategy {
        ...
        returns (IDistributionContract lbp)
    {
        ...
        lbp = IDistributionContract(
            address(
                new SSLForTokenLBPStrategyBasicHarness{salt: _salt}(
                    token,
                    uint128(totalSupply),
                    migratorParams,
                    auctionParams,
